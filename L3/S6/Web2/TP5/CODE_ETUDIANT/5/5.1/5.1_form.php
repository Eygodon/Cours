...
<html lang="fr">
    ...
    <body>
        ...
        <h1>exo 5.1, formulaire</h1>

        <!-- TODO : il manque la balise "enctype" pour envoyer un fichier via le formulaire -->
        <form id="id_form"
              action="traitement.php"
              method="post">

            <!-- TODO :
                    dans les balises "input" et quelques autres il manque la balise "name"
                    elles sont laissées avec le contenu "???" pour les repérer
            -->
            <fieldset>
                ...
                <p>
                    ...
                    <input type="text" name="???" id="id_f_nom" size="20"
                           maxlength="30" value=""
                           tabindex="10" />
                </p>
                ...
                <p>
                    ...
                    <input type="text" name="???" id="id_f_nom_interne"
                ...
                <p>
                    ...
                    <input type="password" name="???" id="id_f_passwd"
                           size="8" maxlength="20" value="" tabindex="30" />
                </p>

                <p>
                    <label for="id_f_cv">CV</label><br />
                    <textarea name="???" id="id_f_cv" rows="4" cols="20" tabindex="40"></textarea>
                </p>

                <p>
                    <label>données cachées ! donc on ne les voie pas</label><br />
                    <input type="hidden" name="???" id="id_f_cache" value="test caché" />
                </p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input type="radio" name="???" id="id_f_r1_m"
                           value="M" tabindex="60" />
                    <label for="id_f_r1_m">Monsieur</label>
                    <br />

                    <input type="radio" name="???" id="id_f_r1_mme"
                           value="Mme" tabindex="70" />
                    <label for="id_f_r1_mme">Madame</label>
                    <br />

                    <input type="radio" name="???" id="id_f_r1_mlle"
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <select name="???" id="id_f_liste2" size="1" tabindex="180">
                ...
                <p>
                    ...
                    <select name="???" id="id_f_liste3" size="3" tabindex="190">
                        <optgroup label="Amérique">
                            <option value="canada"> Canada </option>
                ...
                <p>
                    ...
                    <select name="???" id="id_f_liste4" size="5" multiple="multiple"
                            tabindex="200">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input type="file" name="???" id="id_f_fichier" size="40"
                           tabindex="210" />
                </p>
            </fieldset>
